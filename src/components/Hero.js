...
function Hero() {
  ...
  const nameText = Typewriter({
    words: ['Francis Beam Santander'],
    delaySpeed: 2500,
  })
  return (
    <section className='hero-section' id='hero'>
      <div className='wrapper'>
          ...
          <div className='hero-content'>
            <p className='animate__animated animate__fadeInDown sub-head'>
                Hi, my name is
            </p>
          ...
          <svg className='element4' width="214" height="210" viewBox="0 0 214 210" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path className='animate__animated animate__rotateIn' d="M35 31V30H34V31H35ZM173 31H174V30H173V31ZM173 169V170H174V169H173ZM35 169H34V170H35V169ZM35 32H173V30H35V32ZM172 31V169H174V31H172ZM173 168H35V170H173V168ZM36 169V31H34V169H36Z" fill="#C9C9C9" mask="url(#path-1-inside-1_758_23)"/>
            ...
            <circle className='animate__animated animate__rotateInDownLeft animate__delay-1s' cx="173" cy="169" r="40.5" stroke="#CDCDCD"/>
          </svg>
